...
import { BarChart3, Users, Coins, TrendingUp, DollarSign, Eye, Crown, ArrowRight } from 'lucide-react'
          ...
          <CardContent className="py-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-medium text-sm">Planos de assinatura</p>
                  <p className="text-xs text-muted">Configure precos e promocoes</p>
                </div>
              </div>
